...
{
    /// <summary>
    /// Edge Line Database Context (jarvis_edge_db)
    /// Autonomous store for sub-50ms PLC API calls, active line process flows, and audit logs.
    /// </summary>
    public class EdgeDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.ToTable("edge_process_flows");
            ...
            {
                entity.ToTable("edge_process_steps");
                entity.HasKey(e => e.Id);
            ...
            {
                entity.ToTable("edge_process_operations");
                entity.HasKey(e => e.Id);
            ...
            {
                entity.ToTable("edge_process_result_definitions");
                entity.HasKey(e => e.Id);
            });

            modelBuilder.Entity<StationStepMapping>(entity =>
            {
                entity.ToTable("edge_station_step_mappings");
                entity.HasKey(e => e.Id);
            });
